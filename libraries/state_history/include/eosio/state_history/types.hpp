...
using state_request = fc::variant<get_status_request_v0, get_blocks_request_v0, get_blocks_ack_request_v0>;
...
using action_trace = fc::variant<action_trace_v0, action_trace_v1>;
...
using partial_transaction = fc::variant<partial_transaction_v0, partial_transaction_v1>;

struct transaction_trace_recurse;

struct transaction_trace_v0 {
   using transaction_trace                       = fc::variant<transaction_trace_v0>;
